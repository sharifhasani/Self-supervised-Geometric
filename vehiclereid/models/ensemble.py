...
from .keypoints_extract import KeypointsExtractionModule_Resnet18
from .branches import ABDModules
from .resnet import ResNet, Bottleneck, BasicBlock, _resnet
...
def resnet50_18(pretrained=False, progress=True, **kwargs):
