...
from vehiclereid.losses.cross_entropy_loss import CrossEntropyLoss

__all__ = ['resnet50', 'resnet50_fc512', 'resnet50_bnneck']
...
def init_pretrained_weights(model, model_url):
    ...
    shared_dict = {k: v for k, v in pretrain_dict.items() if k in model_dict and model_dict[k].size() == v.size()}
...
def resnet50_fc512(pretrained=False, progress=True, **kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
...
def resnet50_bnneck(pretrained=False, progress=True, **kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
